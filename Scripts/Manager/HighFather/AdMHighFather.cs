...
namespace DVAH
{
    ...
    public class AdMHighFather : Singleton<AdMHighFather>, IChildLib
    {
        ...
        public AdMHighFather AssignClickCallBack(Action callback, AD_TYPE adType)
        {
            _clickADCallback[(int)adType] = callback;
            return this;
        }

        public AdMHighFather setOffAdPosition(bool isOff, params AD_TYPE[] aD_TYPE)
        {
        ...
        public AdMHighFather SetAdNativeKeepReload(int ID, bool isKeepReload)
        {
