...
namespace HuynnLib
{
    public class NotiManager : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            if(AdManager.Instant.isAdBanner && (AdManager.Instant.BannerPosition == MaxSdkBase.BannerPosition.BottomCenter||
                AdManager.Instant.BannerPosition == MaxSdkBase.BannerPosition.BottomLeft ||
                AdManager.Instant.BannerPosition == MaxSdkBase.BannerPosition.BottomRight))
